...
namespace mmath
{
	...
	public:
		...
		virtual ~BStree(){}
		state adjust_to_balanced_bstree(Bnode<Type_Bstree> *root);
		state delete_node_pro(Bnode<Type_Bstree> *node);
		state delete_node_and_adjust_to_bstree(Bnode<Type_Bstree> *node);
